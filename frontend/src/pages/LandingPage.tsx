        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <h2 className="text-prmsu-maroon font-bold tracking-wider text-sm uppercase mb-3">What's Happening</h2>
              <h3 className="text-4xl md:text-5xl font-display font-bold text-prmsu-dark">Campus Events</h3>
            </motion.div>
          </div>
